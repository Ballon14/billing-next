...
export const routerSchema = z.object({
  ...
  port: z.union([z.number(), z.string()]).optional().transform(v => v ? Number(v) : 8728),
  username: z.string().min(1, 'Username is required').max(100),
  password: z.string().optional().default(''),
  api_port: z.union([z.number(), z.string()]).optional().nullable().transform(v => v ? Number(v) : null),
...
export const pppoeAccountSchema = z.object({
  customer_id: z.union([z.number(), z.string()]).transform(v => Number(v)),
  router_id: z.union([z.number(), z.string()]).optional().nullable().transform(v => v ? Number(v) : null),
